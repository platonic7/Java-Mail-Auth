                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>会員ログイン</strong> Login Form</h1>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="" method="post" class="login-form">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="username" placeholder="例：test@example.com" class="form-username form-control" id="form-username">
			                        </div>
			                        <div class="form-group">
...
<!--                     <div class="row">
        ...
        <!--[if lt IE 10]>
            <script src="form-3/assets/js/placeholder.js"></script>
        <![endif]-->
